...
RUN set -eux ; \
	...
	cp /tmp/eclipse-rdf4j-${rdf4j_version}/war/rdf4j-server.war /usr/local/tomcat/webapps/ ;\
	cp /tmp/eclipse-rdf4j-${rdf4j_version}/war/rdf4j-workbench.war /usr/local/tomcat/webapps/ ;\
	...
	cp /tmp/semanticturkey-${st_version}/system/it/uniroma2/art/semanticturkey/st-trivial-inference-sail/${st_version}/st-trivial-inference-sail-${st_version}.jar /usr/local/tomcat/lib/ ; \
	cp /tmp/semanticturkey-${st_version}/system/it/uniroma2/art/semanticturkey/st-changetracking-sail/${st_version}/st-changetracking-sail-${st_version}.jar /usr/local/tomcat/lib/ ; \
